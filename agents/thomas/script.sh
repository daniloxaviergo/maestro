#!/bin/bash
# thomas script
# This script is executed when a task is assigned to thomas
...
echo "[$(date '+%Y-%m-%d %H:%M:%S')] thomas: Processing task: $TASK_FILE"
echo "[$(date '+%Y-%m-%d %H:%M:%S')] thomas: Task ID: $TASK_ID"
